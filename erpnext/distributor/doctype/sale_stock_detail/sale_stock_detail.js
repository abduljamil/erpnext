			...
			frappe.call({
				...
				callback: function (r) {
					...
					for (let index = 0; index < len; index++) {
						...
						if(dist_city=="Bhakkar" || dist_city=="Faisalabad" || dist_city=="Gujrat" || dist_city=="Mainwali" || dist_city=="Sargodha" || dist_city=="Toba Tek Singh" || dist_city=="Sialkot" || dist_city=="Kasur"){
